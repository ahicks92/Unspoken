...
def init_camlorn_audio(shouldHaveHrtf=True, channels="stereo", frequency=44100, backend_order="mmdevapi,dsound,winmm", period_size=128, periods=4):
 """Initialize camlorn_audio.  The defaults are good enough for most cases."""
 _camlorn_audio.CA_initCamlornAudio(1 if shouldHaveHrtf else 0, channels, frequency, backend_order, period_size, periods)
...
class Playable(CAObject):
 ...
 def set_volume(self, volume) :
  ...
  _camlorn_audio.CA_Playable_setVolume(self.handle, volume)
